---
title: Career Development for Technical Professionals
...
graph TB
    ...
    Junior -->|Focus: Learning & Execution| Mid
    Mid -->|Focus: Autonomy & Scope| Senior
    Senior -->|Focus: Impact & Leadership| Staff

    subgraph "Junior Level"
        J1[Learn tech stack]
        J2[Complete assigned tasks]
        J3[Seek feedback actively]
    end

    subgraph "Mid-level"
        M1[Own features end-to-end]
        M2[Mentor juniors]
        M3[Cross-team collaboration]
    end

    subgraph "Senior Level"
        S1[Drive technical strategy]
        S2[Influence org decisions]
        S3[Build inclusive culture]
    end

    subgraph "Staff Level"
        ST1[Multi-team impact]
        ST2[Industry recognition]
        ST3[Long-term vision]
    end
```
...
graph LR
    ...
    subgraph "Career Stages"
        C1[Junior: 70% Tech, 30% Soft]
        C2[Mid: 50% Tech, 50% Soft]
        C3[Senior: 40% Tech, 60% Soft]
        C4[Staff: 30% Tech, 70% Soft]
    end
...
```mermaid
gantt
    title Job Search Timeline (Recommended: 3-4 months)
    dateFormat  YYYY-MM-DD
    section Preparation
    Research & Skills Gap     :a1, 2024-01-01, 30d
    Resume & Portfolio Update :a2, after a1, 14d
    Networking & Referrals    :a3, after a1, 45d
    section Application
    Active Applications       :b1, after a2, 30d
    Interview Prep            :b2, after a1, 30d
    section Decision
    Offer Evaluation          :c1, after b1, 14d
    Negotiation               :c2, after c1, 7d
    Transition                :c3, after c2, 14d
```
