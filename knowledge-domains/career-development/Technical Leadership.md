...
graph TB
    ...
    subgraph "Technical Excellence"
        TE1[Architecture Decisions]
        TE2[Code Quality]
        TE3[Technical Strategy]
        TE4[Innovation]
    end
    ...
    subgraph "Project Delivery"
        ...
        PD2[Execution]
        PD3[Risk Management]
        PD4[Stakeholder Communication]
    end

    subgraph "Cross-functional Impact"
        CF1[Collaboration]
        CF2[Standards Setting]
        CF3[Technical Evangelism]
        CF4[Organizational Influence]
    end
