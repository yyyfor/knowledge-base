---
title: Career Development Knowledge Map
tags: [career, development, professional-growth]
difficulty: beginner
...
```mermaid
flowchart TD
    Stage[职业阶段与目标] --> Self[Self Development]
    Stage --> Comm[Communication Skills]
    Stage --> Lead[Leadership]
    Stage --> Growth[Career Progression]
    Stage --> Resilience[Mental Health and Well-being]
    Stage --> Signal[Specialized Topics]

    Self --> Goals[Goal Setting and Planning]
    Self --> Learn[Continuous Learning Strategies]
    Self --> Time[Time Management and Productivity]
    ...
    Growth --> Promo[Promotion Readiness]
    Growth --> Search[Job Search Strategy]
    Growth --> Negotiate[Salary Negotiation]

    Signal --> Brand[Building Personal Brand]
```
